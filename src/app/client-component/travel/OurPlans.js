...
import { getTravel , deleteTravel } from "../../../utils/APIs";
...
const OurPlans = () => {
  ...
  const onClickContact = () => {
    window.open('https://www.titotours.in/contactus')
  }
                    ...
                    <div className="card tour shadow">
                      ...
                      <div className="card-body bg-dark text-light tour-body text-center">
                        ...
                        <div className="btn-group">
                          {cookies?.user?.role !== 'admin' && <button className="btn btn-success" onClick={onClickContact}>
