      ...
      <div className="" style={{ margin: "0 -2.25rem" }}>
        <div className="CmtLayout-content css-m7fmz7">
          <div className="CmtLayout-root css-7u9s91">
              ...
              <div className="css-1onfrn1">
                <div className="MuiCardHeader-root css-t7d2qp">
                  <div className="MuiCardHeader-avatar css-1p83tvv">
                    <div className="MuiAvatar-root MuiAvatar-circular css-h1p9ca">
                      {cookie?.user?.avatar ? (
                        <img alt="Remy Sharp" src={cookie?.user?.avatar} className="MuiAvatar-img css-1hy9t21" />
                      ) : (
                        <img alt="Remy Sharp" src={require("../../assets/images/faces/face1.jpg")} className="MuiAvatar-img css-1hy9t21" />
                      )}
                    </div>
                  </div>
                  <div className="MuiCardHeader-content css-11qjisw">
                    <span className="MuiTypography-root MuiTypography-body2 MuiCardHeader-title css-1rnw72g">{cookie?.user?.name}</span>
                    <p className="MuiTypography-root MuiTypography-body1 css-flosfx">{cookie?.user?.address}</p>
                  </div>
                ...
                <div className="css-69i1ev">
                  ...
                  <div className="css-1tu59u4">
                    <button onClick={() => setShow(true)} className="MuiButtonBase-root MuiButton-root MuiButton-text MuiButton-textPrimary MuiButton-sizeMedium MuiButton-textSizeMedium css-rdgd1y" tabIndex="0" type="button">
            ...
            <div className="CmtLayout-wrapper MuiBox-root css-1ofxjzb mb-3"style={{alignItems:'baseline'}}>
                      ...
                      <ul className="MuiList-root css-f9w29w">
                        <li className="MuiListItem-root MuiListItem-gutters MuiListItem-padding MuiListItem-alignItemsFlexStart css-1f151m1"><div className="MuiListItemIcon-root MuiListItemIcon-alignItemsFlexStart css-2h18d4">
                          ...
                          <div className="MuiListItemText-root MuiListItemText-multiline css-1xar93x">
                            ...
                            <p className="MuiTypography-root MuiTypography-body2 MuiListItemText-secondary css-15mdt76">
                              <a className="MuiTypography-root MuiTypography-body1 MuiLink-root MuiLink-underlineNone css-zknl6a" href="#">{cookie?.user?.email}</a>
                            </p>
                          </div>
                        </li>
                        <li className="MuiListItem-root MuiListItem-gutters MuiListItem-padding MuiListItem-alignItemsFlexStart css-1f151m1">
                          ...
                          <div className="MuiListItemText-root MuiListItemText-multiline css-1xar93x">
                            ...
                            <p className="MuiTypography-root MuiTypography-body1 css-s1cnk">{cookie?.user?.contactno}</p>
                          </div>
                        </li>
                      </ul>
                    </div>
                    ...
                    <ul className="MuiList-root css-1igju9t">
                      <li className="MuiListItem-root MuiListItem-gutters MuiListItem-padding css-16fnjgr">
                        ...
                        <div className="MuiListItemText-root MuiListItemText-multiline css-1xar93x">
                          ...
                          <p className="MuiTypography-root MuiTypography-body1 css-s1cnk">{moment(cookie?.user?.dob).format('DD-MM-YYYY')}</p>
                        </div>
                      </li>
                      <li className="MuiListItem-root MuiListItem-gutters MuiListItem-padding css-16fnjgr">
                        <div className="MuiListItemIcon-root css-12rpcfg">
                        ...
                        <div className="MuiListItemText-root MuiListItemText-multiline css-1xar93x">
                          <h6 className="MuiTypography-root MuiTypography-h6 css-1qe7fy0">Lives in</h6>
                          <p className="MuiTypography-root MuiTypography-body1 css-s1cnk">{cookie?.user?.country}</p>
                        </div>
                      </li>
                    </ul>
                  </div>
