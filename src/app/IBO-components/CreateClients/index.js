...
import { CreateUser, getBranchesClient, getIBOsClient, getConnect,getIBOs, userLogout, getProductsList, getProductsListClient } from "../../../utils/APIs";
...
const CreateClints = () => {
    ...
    const getClientDetail = async () =>{
      // try {
      //   const items = await(
      //     await getConnect(10, 1, queryParams.id)
      //   ).data;
      //   setClientlist(items?.results);
      // } catch (error) {
