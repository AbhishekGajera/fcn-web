...
export const getNotificationByAudience = (status="1",targetAudience='all') => api(`notification/fetch-notification?status=${status}&targetAudience=all&sortBy=createdAt:desc`, 'GET');
